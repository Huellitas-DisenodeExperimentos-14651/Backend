package pe.edu.upc.patitasolidaria.backend.iam.infrastructure.authorization.sfs.configuration;
...
import pe.edu.upc.patitasolidaria.backend.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import pe.edu.upc.patitasolidaria.backend.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
        ...
        .sessionManagement(customizer -> customizer.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
            .authorizeHttpRequests(
                    authorizeRequests -> authorizeRequests.requestMatchers(
                                    "/api/v1/authentication/sign-in",  // ✅ esta es la ruta usada en el curl
                                    "/api/v1/authentication/sign-up",  // si también permites el registro
                                    "/v3/api-docs/**",
                                    "/swagger-ui.html",
                                    "/swagger-ui/**",
                                    "/swagger-resources/**",
